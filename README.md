...
The analysis was performed entirely in Google Colab as per assignment requirements. Feature Engineering - Extracted date, hour, weekday
- Merged sentiment (fear/greed index)
- Created metrics such as: - Profitability flags
- Win/loss outcomes
- Trade size categories
- Normalized PnL

Exploratory Data Analysis (EDA) Generated multiple plots including:
